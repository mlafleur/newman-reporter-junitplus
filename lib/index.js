 ...
 * @returns {*}
 */
JunitPlusReporter = function (newman, options, collectionRunOptions) {
    newman.on('beforeDone', function () {
        ...
        _.forEach(cache, function (executions, itemId) {
            ...
            _.forOwn(tests, function (failures, name) {
                ...
                testcase.att('name', util.getFullName(currentItem) + "/" + name);
...
module.exports = JunitPlusReporter;